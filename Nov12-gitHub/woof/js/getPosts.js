        ...
        success:function(data){
            ...
            if(data['admin']){
                ...
                for(i=0;i<data['admin'].length;i++){
                    ...
                    $('#adminPosts').append("<div class=adminBlock id="+data['admin'][i]['post_id']+"><a href='showpost.php?post_id="+data['admin'][i]['post_id']+"'><div>"+data['admin'][i]['post_create_time']+"</div><div><img src='post_image/"+data['admin'][i]['post_image']+"' alt='post image' class=post_image /></div><div>"+data['admin'][i]['post_title']+"</div></a></div>");
