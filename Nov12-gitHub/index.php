...
<head>
	...
	.sliderWrap input, .sliderWrap .slider{
      ...
      <div id="main" class="glow">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>Pett</h1>
                        <h3><a href="https://www.indiegogo.com/projects/pett/x/10128090#/" target="_blank" style="color:#FF69B4"> Watch the Video </a></h3>
                        <hr class="intro-divider">
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="https://www.facebook.com/woofwarrior" target="_blank" class="btn btn-default btn-lg"><i class=""></i> <span class="network-name">Facebook</span></a>
                            </li>
                            <li>
                                <a href="https://www.indiegogo.com/projects/pett/x/10128090#/" target="_blank" class="btn btn-default btn-lg"><i class=""></i> <span class="network-name">Indie Go Go</span></a>
                            </li>
                            <li>
                                <a href="#footer" class="btn btn-default btn-lg"><i class=""></i> <span class="network-name">Subscribe</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
       ...
       <div class="content wrapper main-wrapper" role="main"> 
            ...
            <section class="hero-banner events" style="height:900px"> 
                ...
                <div class="sliderWrap glow">
                <input type="button" style="font-size:30px; color:#41EAFF; background:black; border:0;text-align: center; line-height: 1em;"  value="&#10096;" id="prev"/>
                <div class="slider">
                
                
                    <div class="sliderContent"; style="width:200px; data-width:20%; height:600px; float:left; display:inline-block; background-color:white;">
                    ...
                    <div class="sliderContent"; id="paypal"  style="width:200px; data-width:20%; height:600px; float:left; display:inline-block; background-color:white;">
                    ...
                    <div class="sliderContent"; id="mc_embed_signup"  style="width:250px; data-width:20%; height:600px; float:left; display:inline-block;" > <!-- Begin MailChimp Signup Form -->
                            <link href="//cdn-images.mailchimp.com/embedcode/classic-081711.css" rel="stylesheet" type="text/css">

                            <div class="sliderContent"; id="newsletter"> </div>
                            <table><tbody>
                              <tr>
...
<a href="http://woofwarrior.com/woof/?p=13" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #2BAADF;font-weight: normal;text-decoration: underline;">Read more.</a>
    	...
    	<input type="button" style="font-size:30px; color:#41EAFF; background:black; border:0;text-align: center; line-height: 1em; "  value="&#10097;" id="next"/>
</div>
</div>
</section>
...
We are stoked to see the photos of your dogs this Halloween! Woof Warrior will donate .10 cents for every photo submitted to the shelter sponsor, Max. <A href="http://woofwarrior.com/woof/?p=21">Read more about the contest here</A>
                 ...
                 <section class="blog" style="height:900px; font-size:36px; color:black">
               ...
               <section style="height:100px; font-size:36px; color:black">
               <div id="footer" class="glow footer">
               <link href="//cdn-images.mailchimp.com/embedcode/classic-081711.css" rel="stylesheet" type="text/css">
<style type="text/css">
...
<div id="mc_embed_signup" style="font-size:10px;">
<form action="//woofWarrior.us11.list-manage.com/subscribe/post?u=702c0542aeb77193ca18f4022&amp;id=375dd85035" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	<h2>Follow Woof Warrior Updates</h2>
...
<div class="mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;"><input type="text" name="b_702c0542aeb77193ca18f4022_375dd85035" tabindex="-1" value=""></div>
...
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  ...
  ga('send', 'pageview');
    ...
    $(document).ready(function(){
		$(".slider .sliderContent").each(function(e) {
        if (e != 0)
            $(this).hide();
    });
    ...
    $("#prev").click(function(){
        if ($(".slider .sliderContent:visible").prev().length != 0){
            $(".slider .sliderContent:visible").prev().show().next().hide();
        }else{
            $(".slider .sliderContent:visible").hide();
            $(".slider .sliderContent:last").show();
        }
        return false;
    });
...
function showNext(){
	if($(".slider .sliderContent:visible").next().length != 0){
        $(".slider .sliderContent:visible").next().show().prev().hide();
	}else if(".slider .sliderContent:visible"){
	    $(".slider .sliderContent:visible").hide();
	    $(".slider .sliderContent:first").show();
...
<script type="text/javascript">
_atrk_opts = { atrk_acct:"sx/fm1aIF5R17i", domain:"woofwarrior.com",dynamic: true};
